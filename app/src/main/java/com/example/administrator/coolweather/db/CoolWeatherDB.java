...
public class CoolWeatherDB {
     ...
     * 从数据库读取某城市下所有的县信息
     */
    public List<County> loadCounties(int ciryId){
        List<County> list = new ArrayList<County>();
        Cursor cursor = db.query("County",null,"city_id = ?",new String[]{String.valueOf(ciryId)},null,null,null);
        if (cursor.moveToFirst()){
            do {
